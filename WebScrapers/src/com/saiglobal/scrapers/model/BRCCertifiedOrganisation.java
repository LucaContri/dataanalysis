...
public class BRCCertifiedOrganisation {
	private static final SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
	private String BRCSiteCode, companyName, contact, contactEMail, contactPhone, contactFax, address, city, postCode, regionState, country, phone, fax, email, website, standard, grade, scope, exclusion, certificationBody, auditCategory, commercialContact, commercialContactEmail, commercialContactPhone, codes;
	...
	public String getBRCSiteCode() {
		return BRCSiteCode;
	}
	public void setBRCSiteCode(String bRCSiteCode) {
		BRCSiteCode = bRCSiteCode;
	}
