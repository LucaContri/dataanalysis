...
DROP TABLE IF EXISTS analytics.postcodes_geo;
CREATE TABLE analytics.postcodes_geo (
...
INSERT INTO analytics.postcodes_geo (postcode, suburb, state, latitude, longitude) VALUES
