...
/*
 * Combines:
 * 	 	BusinessRule_SameCountry
 * 		BusinessRule_BusinessUnit
 * 		BusinessRule_ResourceCost
 * 		BusinessRule_TravelCostFromHome
 * 		BusinessRule_ResourceUtilization
 * to improve performance
 */
public class BusinessRule_Combined_1 extends AbstractBusinessRule {
	
	private static final Logger logger = Logger.getLogger(BusinessRule_Combined_1.class);
	public BusinessRule_Combined_1(DbHelper db) {
		super(db);
	}
	...
	public HashMap<String, Resource> filter(WorkItem workItem, HashMap<String, Resource> resourceIdWithScore) throws SQLException, ClassNotFoundException, IllegalAccessException, InstantiationException {
		...
		Utility.startTimeCounter("BusinessRule_Combined_1");
		...
		Utility.stopTimeCounter("BusinessRule_Combined_1");
