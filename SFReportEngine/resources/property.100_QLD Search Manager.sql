--100 Overdure Cerficates - QLD

SELECT          

DISTINCT o.OrderID 'Order ID',          
co.certificateorderid 'Certificate ID',         
 act.ProductName 'Product Name',          
 ABS(DATEDIFF(DAY,          
 atr.transtime,          
 GETDATE())) - ABS(DATEDIFF(WEEK, atr.transtime, GETDATE())*2) - act.overduedays 'Overdue',
