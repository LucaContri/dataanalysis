...
public class PropertyAgentReportConfirmedReport extends AbstractQueryReport {
	
	private Calendar fromDate = Calendar.getInstance();
	private Calendar toDate = Calendar.getInstance();
	
	public PropertyAgentReportConfirmedReport() {
		setExecuteStatement(false);
		setHeader(true);
		dateTimePattern = "d/MM/yyyy";
		columnWidth = new int[] {80,150,80,80,80,80,80,80,80,80,300,80,80,80,80,80,80,80,80};
	}
	...
	protected void initialiseQuery() throws Exception {
		...
		String stmt =
				...
				" INSERT #FooQLDIpswitch EXEC p_LoadSettlement -1, -1, -2, NULL, '" + dateFormat.format(fromDate.getTime()) + "' ,'" + dateFormat.format(toDate.getTime()) + "', 1, 4, 0 , NULL; " +
				" INSERT #FooQLD EXEC p_LoadSettlement 2, -1, -2, NULL, '" + dateFormat.format(fromDate.getTime()) + "' ,'" + dateFormat.format(toDate.getTime()) + "', 1, 4, 0 , NULL; " +
				" INSERT #FooQLDBrisSuburbs EXEC p_LoadSettlement 4, -1, -2, NULL, '" + dateFormat.format(fromDate.getTime()) + "' ,'" + dateFormat.format(toDate.getTime()) + "', 1, 4, 0 , NULL; " +
				" INSERT #FooQLDGoldCoast EXEC p_LoadSettlement 6, -1, -2, NULL, '" + dateFormat.format(fromDate.getTime()) + "' ,'" + dateFormat.format(toDate.getTime()) + "', 1, 4, 0 , NULL;  " +
				" INSERT #FooVICMelbMetro EXEC p_LoadSettlement 8, -1, -2, NULL, '" + dateFormat.format(fromDate.getTime()) + "' ,'" + dateFormat.format(toDate.getTime()) + "', 1, 4, 0 , NULL; " +
				" INSERT #FooNTAll EXEC p_LoadSettlement 11, -1, -2, NULL, '" + dateFormat.format(fromDate.getTime()) + "' ,'" + dateFormat.format(toDate.getTime()) + "', 1, 4, 0 , NULL; " +
				" INSERT #FooNSWRegional EXEC p_LoadSettlement 12, -1, -2, NULL, '" + dateFormat.format(fromDate.getTime()) + "' ,'" + dateFormat.format(toDate.getTime()) + "', 1, 4, 0 , NULL; " +
				" INSERT #FooVICRegional EXEC p_LoadSettlement 14, -1, -2, NULL, '" + dateFormat.format(fromDate.getTime()) + "' ,'" + dateFormat.format(toDate.getTime()) + "', 1, 4, 0 , NULL;  " +
				" INSERT #FooQLDSunshine EXEC p_LoadSettlement 17, -1, -2, NULL, '" + dateFormat.format(fromDate.getTime()) + "' ,'" + dateFormat.format(toDate.getTime()) + "', 1, 4, 0 , NULL; " +
				" INSERT #FooTASAll EXEC p_LoadSettlement 21, -1, -2, NULL, '" + dateFormat.format(fromDate.getTime()) + "' ,'" + dateFormat.format(toDate.getTime()) + "', 1, 4, 0 , NULL;  " +
				" INSERT #FooWABunbury EXEC p_LoadSettlement 25, -1, -2, NULL, '" + dateFormat.format(fromDate.getTime()) + "' ,'" + dateFormat.format(toDate.getTime()) + "', 1, 4, 0 , NULL; " +
				" INSERT #FooWAAllOther EXEC p_LoadSettlement 28, -1, -2, NULL, '" + dateFormat.format(fromDate.getTime()) + "' ,'" + dateFormat.format(toDate.getTime()) + "', 1, 4, 0 , NULL; " +
				" INSERT #FooWAPerthMetro EXEC p_LoadSettlement 29, -1, -2, NULL, '" + dateFormat.format(fromDate.getTime()) + "' ,'" + dateFormat.format(toDate.getTime()) + "', 1, 4, 0 , NULL;";
	...
	protected String getQuery() {
		String select = 
					...
					" 'QLD' AS 'State'FROM #FooQLDIpswitch a " +
					" JOIN TB_POSTCODECLIENTREGION p ON a.postcode=p.postcode WHERE " +
					" site_desc = 'ANZ'GROUP BY " +
					" a.MatterSSRNumber, " +
					" a.MatterName, " +
					" a.loanAccountNumber, " +
