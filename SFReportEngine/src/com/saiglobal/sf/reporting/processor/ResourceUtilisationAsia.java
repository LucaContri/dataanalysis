...
public class ResourceUtilisationAsia extends AbstractQueryReport {
	...
	protected String getQuery() {
		return "SELECT  " + 
 "		 SUBSTRING_INDEX(i.`Business Unit`, '-', -(1)) as 'Country', i.`Manager`, i.`Name`, i.`Resource Capacitiy (%)`, i.`Period`, j.`Working Days`, i.`Audit Days`, i.`Travel Days`, i.`Holiday Days`, i.`Leave Days`, " + 
 ...
 "    group by Id, i.Period;";
	...
	protected String getReportName() {
		return "Resource Planning\\Resource Utilisation\\Resource Utilisation Asia";
	}
	
	@Override
	protected String getTitle() {
		return "Resource Utilisation Asia";
	}
}
