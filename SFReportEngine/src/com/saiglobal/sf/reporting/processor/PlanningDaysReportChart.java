...
public class PlanningDaysReportChart implements ReportBuilder {
	private DbHelper db;
	...
	private static final Logger logger = Logger.getLogger(PlanningDaysReportChart.class);
	...
	public PlanningDaysReportChart() {
	...
	*/
	public String[] getReportNames() {
		return new String[] {"..\\Charts\\Planning Day Report (MS and Food)"};
	}
	
	public String[] getFileReportNames() {
		return new String[] {"Planning Day Report"};
	}
