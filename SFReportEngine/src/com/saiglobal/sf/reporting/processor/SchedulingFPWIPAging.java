...
public class SchedulingFPWIPAging extends AbstractQueryReport {

	public SchedulingFPWIPAging() {
	...
	protected String getReportName() {
		return "Enlighten\\SchedulingFP.WIP";
	}
	
	@Override
	protected String getTitle() {
		return "Scheduling FP - Aging Backlog";
	}
}
