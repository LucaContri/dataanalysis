...
public class PropertyBankwestRegistrationsInProgress extends AbstractQueryReport {
	
	public PropertyBankwestRegistrationsInProgress() {
	...
	protected String getQuery() {
		...
		String select = "select " + 
				...
				"T2.IsFileWithClient as With_Client " + 
				"from " + 
				"( " + 
				"select " + 
				"TB_ACCOUNT.Account_code, " + 
				"TB_MATTER.MatterSSRNumber, " + 
				"MAX(TB_SETTLEMENT.Settlement_datetime) as Settlement_Date " + 
				"FROM " + 
				...
				"AND (TB_ACCOUNT.Account_code = 'BWBUWA' OR TB_ACCOUNT.Account_code = 'bwbcs' OR TB_ACCOUNT.Account_code = 'BWESTREL' OR TB_ACCOUNT.Account_code = 'BWESTEXAMS' OR TB_ACCOUNT.Account_code = '8bwest358' OR TB_ACCOUNT.Account_code = '8bwest205')  " + 
				...
				"AND TB_SERVICE.ServiceStatus_Id <> '6'  " + 
				"AND TB_SERVICE.ServiceStatus_Id <> '2'  " + 
				"AND TB_DOCUMENT.isLodgeLocked = 'Y'  " + 
				"group by " + 
				"TB_MATTER.MatterSSRNumber, " + 
				"TB_ACCOUNT.Account_code, " + 
				"TB_REGISTRATION.Due_datetime, " + 
				...
				"TB_MATTER.IsFileWithClient " + 
				") T2 " + 
				"on T1.MatterSSRNumber = T2.MatterSSRNumber  " + 
				"left join " + 
				"( " + 
				"select " + 
				"TB_MATTER.MatterSSRNumber, " + 
				"MAX(TB_MATTERNOTE.Created_datetime) AS Requisition_Date " + 
				"FROM         " + 
				"TB_MATTER INNER JOIN " + 
				"TB_ACCOUNT ON TB_MATTER.Account_Id = TB_ACCOUNT.Account_Id INNER JOIN " + 
				"TB_DOCUMENT ON TB_DOCUMENT.Matter_Id = TB_MATTER.Matter_Id INNER JOIN " + 
				...
				"WHERE  TB_MATTER.MatterStatus_Id = '6'  " + 
				"AND (TB_ACCOUNT.Account_code = 'BWBUWA' OR TB_ACCOUNT.Account_code = 'bwbcs' OR TB_ACCOUNT.Account_code = 'BWESTREL' OR TB_ACCOUNT.Account_code = 'BWESTEXAMS' OR TB_ACCOUNT.Account_code = '8bwest358' OR TB_ACCOUNT.Account_code = '8bwest205')  " + 
				"AND TB_MATTERNOTE.MatterNoteType_Id = '14' " + 
				"group by " + 
				"TB_MATTER.MatterSSRNumber " + 
				") T3 " + 
				"on T1.MatterSSRNumber = T3.MatterSSRNumber OR T2.MatterSSRNumber = T3.MatterSSRNumber";
	...
	protected String getReportName() {
		return "Registrations In Progress - Bankwest";
	}
