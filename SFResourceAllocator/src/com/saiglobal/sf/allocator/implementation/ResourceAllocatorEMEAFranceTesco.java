...
public class ResourceAllocatorEMEAFranceTesco implements Allocator {
	
	protected Logger logger = Logger.getLogger(ResourceAllocatorEMEAFranceTesco.class);
	...
	public ScheduleParameters getParameters(GlobalProperties cmd) {
		...
		parameters.setBatchId("EMEA Tesco France Capacity Planning - 2017");
		//parameters.setRevenueOwnership(new CompassRevenueOwnership[] {CompassRevenueOwnership.EMEASpain});
		parameters.setAuditorsCountries(new String[] {"France"});
		parameters.setWiCountries(new String[] {"France"});
		...
		parameters.setResourceIds(new String[] {
				// "a0nd0000003Z7OQAA0", // Audrey Barbier" Based in Cyprus???
