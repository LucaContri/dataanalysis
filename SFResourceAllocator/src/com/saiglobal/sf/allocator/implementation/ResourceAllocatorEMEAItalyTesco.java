...
public class ResourceAllocatorEMEAItalyTesco implements Allocator {
	
	protected Logger logger = Logger.getLogger(ResourceAllocatorEMEAItalyTesco.class);
	...
	public ScheduleParameters getParameters(GlobalProperties cmd) {
		...
		parameters.setBatchId("EMEA Tesco Italy Capacity Planning - 2017");
		//parameters.setRevenueOwnership(new CompassRevenueOwnership[] {CompassRevenueOwnership.EMEASpain});
		parameters.setAuditorsCountries(new String[] {"Italy"});
		parameters.setWiCountries(new String[] {"Italy"});
		...
		parameters.setResourceIds(new String[] {
				// "a0nd0000005YBNCAA4", // Enrico Girotto no longer available
