...
public class PSResourceAllocator2016 implements Allocator {
	
	protected Logger logger = Logger.getLogger(PSResourceAllocator2016.class);
	...
	public ScheduleParameters getParameters(GlobalProperties cmd) {
		...
		parameters.setBatchId("PS 2016 Completed");
		...
		parameters.setRepotingBusinessUnits(new CompassRevenueOwnership[] {
				CompassRevenueOwnership.AUSProductServices});
		parameters.setFixedCapacity(new Double(80));
		...
		parameters.setBusinessLine("Product Services");
		...
		cal2.set(2016, Calendar.JANUARY, 1, 0, 0, 0);
		...
		cal2.set(2016, Calendar.DECEMBER, 31, 23, 59, 59);
