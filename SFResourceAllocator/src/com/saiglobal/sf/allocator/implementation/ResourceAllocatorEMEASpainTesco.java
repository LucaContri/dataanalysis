...
public class ResourceAllocatorEMEASpainTesco implements Allocator {
	
	protected Logger logger = Logger.getLogger(ResourceAllocatorEMEASpainTesco.class);
	...
	public ScheduleParameters getParameters(GlobalProperties cmd) {
		...
		parameters.setBatchId("EMEA Tesco Spain Capacity Planning - 2017");
		//parameters.setRevenueOwnership(new CompassRevenueOwnership[] {CompassRevenueOwnership.EMEASpain});
		parameters.setAuditorsCountries(new String[] {"Spain"});
		parameters.setWiCountries(new String[] {"Spain", "Portugal"});
		...
		parameters.setResourceIds(new String[] {"fake_resource_0001", "fake_resource_0002", "fake_resource_0003", "a0nd0000000hAzZAAU", "a0nd00000065otnAAA"});
												//Esther			, Elise				  , Maribel				, Christel Kaberghs   , Yobana Bermudez
