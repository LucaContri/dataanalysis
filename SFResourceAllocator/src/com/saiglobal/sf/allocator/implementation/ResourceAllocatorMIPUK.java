...
public class ResourceAllocatorMIPUK implements Allocator {
	
	protected Logger logger = Logger.getLogger(ResourceAllocatorMIPUK.class);
	...
	public ScheduleParameters getParameters(GlobalProperties cmd) {
		...
		parameters.setBatchId("UK Forward Planning");
