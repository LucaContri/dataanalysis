...
public class ProcessorUKFood extends AbstractProcessor {
	private static List<ProcessorRule> rules = new ArrayList<ProcessorRule>(); 
	
	public ProcessorUKFood(DbHelper db, ScheduleParameters parameters) throws Exception {
		super(db, parameters);
	...
	protected Logger initLogger() {
		return Logger.getLogger(ProcessorUKFood.class.toString());
	}
