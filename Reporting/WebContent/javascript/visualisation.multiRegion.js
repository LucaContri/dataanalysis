...
function updateAllVisualisationsForPrinting() {
	$.when( updateAllVisualisations() ).done( function() {
		updateSalesOpportunityDeliveryChartToWeekly("opportunity_delivery_yesterday_chart");
		updateSalesOpportunityDeliveryTableToWeekly("opportunity_delivery_yesterday_table");
		updateOpportunityPipelineChartToWeekly("opportunity_yesterday_chart");
		updateOpportunityPipelineTableToWeekly("opportunity_yesterday_table", "fab_yesterday_ratio_amount", "fab_yesterday_ratio_count");
