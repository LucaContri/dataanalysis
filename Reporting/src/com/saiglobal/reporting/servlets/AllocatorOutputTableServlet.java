...
import com.saiglobal.reporting.utility.AllocatorOutputTableCache;
import com.saiglobal.sf.core.data.DbHelperConnPool;
import com.saiglobal.sf.core.utility.GlobalProperties;
import com.saiglobal.sf.core.utility.Utility;

public class AllocatorOutputTableServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static Logger logger = Logger.getLogger(AllocatorOutputTableServlet.class);
	private static DbHelperConnPool db;
	private static final GlobalProperties gp;
	private static AllocatorOutputTableCache cache;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			cache = AllocatorOutputTableCache.getInstance(db, batchId);
